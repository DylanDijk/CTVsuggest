...
The aim of CTVsuggest is to give suggestions for packages to be added to [CRAN Task Views](https://github.com/cran-task-views/ctv#available-task-views).

There is a single function, `CTVsuggest()`, that outputs these suggestions.
